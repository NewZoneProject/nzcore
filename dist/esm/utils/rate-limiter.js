...
export class RateLimiter {
    constructor(options) {
        ...
        if (options.limit < 1) {
            throw new NewZoneCoreError(ERROR_CODES.VALIDATION_FAILED, 'Rate limit must be at least 1');
        }
        if (options.windowMs < 1) {
            throw new NewZoneCoreError(ERROR_CODES.VALIDATION_FAILED, 'Window must be at least 1ms');
        }
