...
class ForkDetector {
    ...
    static createMergeDocument(conflictHashes, resolution) {
        if (conflictHashes.length < 2) {
            throw new types_js_1.NewZoneCoreError(constants_js_1.ERROR_CODES.FORK_DETECTED, 'Merge requires at least 2 conflicting hashes', { count: conflictHashes.length });
        }
        return {
            type: 'merge',
            version: '1.0',
